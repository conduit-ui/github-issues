...
class Container_d3eb165121 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_d3eb165121 $container)
			{
	...
	public function createServiceContainer(): Container_d3eb165121
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => '/Users/jordanpartridge/packages/conduit-ui/github-issues/phpstan-baseline.neon',
			'usedLevel' => '9',
