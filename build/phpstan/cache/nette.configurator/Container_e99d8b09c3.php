...
class Container_e99d8b09c3 extends _PHPStan_bc6352b8e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_e99d8b09c3 $container)
			{
	...
	public function createServiceContainer(): Container_e99d8b09c3
	{
		return $this;
	}
